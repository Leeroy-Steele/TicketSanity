// Script for manipulating table / ticket results -->
    ...
    function organiseMyList(){
        ...
        sortTableRows('Status', [ "New", "ReOpened*", "Client responded","Client Responded", "In Progress", "In Progress - Do Not Send Email","Testing","Ready for QA","Scheduled"])
    ...
    function organiseMyLisByPriority(){
        ...
        hideRowsWithStatus('Waiting on Dev')
        hideRowsWithStatus('Waiting on 3rd Party')
        sortTableRows('Status', [ "New", "ReOpened*" ,"Client responded","Client Responded", "In Progress", "In Progress - Do Not Send Email","Testing","Ready for QA","Scheduled","Assigned"])
